...
public class ParticleRegistry {
    public static final DeferredRegister<ParticleType<?>> PARTICLE_TYPES = DeferredRegister.create(Registries.PARTICLE_TYPE, FunctionParticle.MODID);
    ...
    public static final Supplier<ParticleType<FogParticleOptions>> FOG_PARTICLE = PARTICLE_TYPES.register("fog", () -> new ParticleType<>(true) {
        public MapCodec<FogParticleOptions> codec() {return FogParticleOptions.MAP_CODEC;}
        public StreamCodec<? super RegistryFriendlyByteBuf, FogParticleOptions> streamCodec() {return FogParticleOptions.STREAM_CODEC;}
    });
    public static final Supplier<ParticleType<BaseParticleOptions>> BASE_PARTICLE = PARTICLE_TYPES.register("base", () -> new ParticleType<>(true) {
        public MapCodec<BaseParticleOptions> codec() { return BaseParticleOptions.MAP_CODEC;}
        public StreamCodec<? super RegistryFriendlyByteBuf, BaseParticleOptions> streamCodec() {return BaseParticleOptions.STREAM_CODEC;}
    });
    public static final Supplier<ParticleType<BaseFunctionOption>> BASE_FUNCTION_PARTICLE = PARTICLE_TYPES.register("base_function", () -> new ParticleType<>(true) {
        public MapCodec<BaseFunctionOption> codec() { return BaseFunctionOption.MAP_CODEC;}
        public StreamCodec<? super RegistryFriendlyByteBuf, BaseFunctionOption> streamCodec() {return BaseFunctionOption.STREAM_CODEC;}
    });
